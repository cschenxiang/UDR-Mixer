...
parser.add_argument('--patch_size', type=int, default=768, help='patchsize of input.')
parser.add_argument('--num_workers', type=int, default=16, help='number of workers.')

# path
parser.add_argument('--data_dir', type=str, default='data/Train/',  help='where images saves.')
